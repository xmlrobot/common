 ...
 * 
 * <h2>Abstract</h2>
 * <p>Polymorphic implementation of a {@code time-listener}. It represents a
 * {@link org.xmlrobot.time.Past} that is {@link org.xmlrobot.time.Future},
 * and viceversa; and, concurrently, this is a {@link org.xmlrobot.Listener}
 * implementation. In recursion, the {@code parent}, the {@code child}, and
 * the {@code time-listener} are the three instances of the {@code org.xmlrobot.TimeListener<K,V>},
 ...
 * in abstraction and being, or existence. {@code org.xmlrobot.TimeListener<K,V>}
 * is a concurrent concurrence: {@code org.xmlrobot.Parent} is parent in
 * abstraction but three in recursion. This mapping concurs recursive inheritance
 * and has been the {@link java.lang.Object} of abstract recurrence for extended
 * {@code time}.
 * 
 * <h3>Parent properties:</h3>
 * <ul>
 * <li>{@code K parent} instance maps to {@link org.xmlrobot.time.Past},
 ...
 * <p><center><img src="doc-files/TimeListener.png" width="400"></center>
 * <p>Where:
 * <ul>
 * <li>Parameter {@code K} extends TimeListener&lt;K,V&gt;</li>
 * <li>Parameter {@code V} extends TimeListener&lt;V,K&gt;</li>
 * </ul>
 * <h3>Instances around {@code time-listener} (or {@code this})</h3>
 * <ul>
 * <li>{@code parent}</li>
 ...
 * </ul>
 * 
 * <h3>How to get {@code time-listener} instance</h3>
 * <ul>
 * <li>{@code parent.child.child}</li>
 * <li>{@code child.parent.child}</li>
 * <li>{@code child.child.parent}</li>
 * </ul>
 * <br>
 * 
 ...
 */
public interface TimeListener<K,V> extends Past<K>, Future<V>, Recursion<K,V> {
